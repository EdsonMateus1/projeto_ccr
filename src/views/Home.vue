<template>
  <div class="home">
    ...
    <div class="container-card">
      ...
      <div style="background-color: #670015" class="card">
        ...
        <div class="card-conted">
          ...
          <span class="description-card"
            >Descubra vagas de emprego de acordo,</span
          >
          <span class="description-card"
            >com sue desempenho,você tera mais</span
          >
    ...
    <footer>
      <div class="footer">
        <div class="container">
          ...
          <div class="grid-4 footer_contato">
            <h3>Contato</h3>
            <ul>
              <li>- +55 (31) 90000-0000</li>
              <li>- contato@readytw.com.br</li>
      ...
      <div class="copy">
        <div class="container">
          <p class="copy-text grid-16">READY TO WORK - 2021 ©</p>
        </div>
      </div>
    </footer>
  </div>
